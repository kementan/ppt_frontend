...
export class ReportCategoryService {
  ...
  exportData(): Observable<any> {
    ...
    return this.http.get(
      env.v1_API + "report-category-export",
      {
  ...
  getList(filter: any): Observable<any> {
    ...
    return this.http.get(
      env.v1_API + "report-category-table",
      {
        headers: new HttpHeaders({ 
            "Content-Type": "application/json",
            "Authorization": `Bearer ${user.data.token}`
  ...
  createData(form: any): Observable<any> {
    ...
    return this.http.post(
      env.v1_API + "report-category-create",
      requestBody,
      {
        headers: new HttpHeaders({
          "Content-Type": "application/json",
  ...
  deleteData(ids: string[]): Observable<any> {
    ...
    return this.http.delete(
      env.v1_API + "report-category-delete",
      options
    );
  }
  ...
  updateData(id:string, form: any): Observable<any> {
    ...
    return this.http.put(
      env.v1_API + "report-category-update",
      requestBody,
      {
        headers: new HttpHeaders({
          "Content-Type": "application/json",
